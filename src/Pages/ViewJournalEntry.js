        ...
        <div className="JournalEntries-card" style={{width: "900px", marginTop: "55px"}}>
            <div className="header">
              <p>Journal Entries</p>
                   ...
                   <div className="backward-forward-icons" style={{marginLeft: "auto", marginRight: "15px",}}>
                        <button disabled><i className="fas fa-step-backward" id=""></i></button>
                        <button disabled><i className="fas fa-backward" id=""></i></button>
                        <span>1/2</span>
                        <button><i className="fas fa-forward" id=""></i></button>
                        <button><i className="fas fa-step-forward" id=""></i></button>
                   </div>
            </div>
          ...
          <div className="footer">
            <button className="button" style={{width: "60px", height: "20px",fontSize: "11px", marginRight: "12px"}}>History</button>
          </div>
        </div>
        </div>
      </div>
