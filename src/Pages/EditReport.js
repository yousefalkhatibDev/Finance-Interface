                ...
                <div className="CreateNewJournalEntry-card">
                      ...
                      <div className="input-group-row">
                        <div className="input-container">
                            ...
                            <select name="Suspense" className="select" >
                                <option  disabled selected>Suspense</option>
                    ...
                    <>
                      ...
                      <div className="input-group-row">
                        ...
                        <div className="input-container">
                            <label>Select</label>
                            <select name="Suspense" className="select" style={{width: "300px"}}>
                        ...
                        <div className="input-container">
                                ...
                                <div className="merge-inputs">
                                    <span className="merge-inputs-addon">
                                        ...
                                        <input type="text" id="text-input" name="text-input" defaultValue="" placeholder='Optional' style={{borderTopLeftRadius: "0px", borderBottomLeftRadius: "0px", textAlign: "start"}}/>
                                </div>
                            </div>                     
                         </div>
                         <div className="input-group-row">
                        <div className="input-container">
                            <select name="Suspense" className="select" style={{width: "150px"}}>
                                <option value="" disabled selected>General Ledger Account</option>
                                <option value="Accounting fees">Accounting fees</option>
                                <option value="Advertising and promotion">Advertising and promotion</option>
                                <option value="Bank charges">Bank charges</option>
                                <option value="Capital gains on investments">Capital gains on investments</option>
                        ...
                        <div className="input-container">
                            <select name="Suspense" className="select" style={{width: "150px", marginLeft: "-6px", marginRight: "5px"}}>
                        ...
                        <div className="input-container">
                         ...
                         </div><div className="input-group-row">
                        <div className="input-container">
                            <select name="Suspense" className="select" style={{width: "300px"}}>
                                <option value="" disabled selected>Debit</option>
                                <option value="Accounting fees">Accounting fees</option>
                                <option value="Advertising and promotion">Advertising and promotion</option>
                                <option value="Bank charges">Bank charges</option>
                                <option value="Capital gains on investments">Capital gains on investments</option>
