      ...
      <PageWrapper>
        <div className="body-content">
            ...
            <a href={
                ...
                {
                    id === "ProfitAndLossStatement" && localStorage.getItem("ProfitAndLossStatement")
                    ?
                        ...
                        <tr>
                            ...
                            <th id="td-3">From</th>
                            <th id="td-4" style={{width: "auto", textAlign: "center"}}>To</th>
                            <th id="td-5" style={{width: "65%", textAlign: "left"}}>Description</th>
                        </tr>
                        {reportsData.map(element => {
                            return (
                            <tr>
                                <td><a href={"/reports/Edit/ProfitAndLossStatement?name=Profit and Loss Statement"}><button>Edit</button></a></td>
                                <td><a href={"/reports/view"}><button>View</button></a></td>
                    ...
                    : id === "ProfitAndLossStatementActualVsBudget" && localStorage.getItem("ProfitAndLossStatementActualVsBudget")
                    ?
                        <table style={{width: "100%"}}>
                        <tr>
                            <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                            ...
                            <th id="td-3">From</th>
                            <th id="td-4" style={{width: "auto", textAlign: "center"}}>To</th>
                            <th id="td-5" style={{width: "65%", textAlign: "left"}}>Title</th>
                        </tr>
                        {reportsData.map(element => {
                            return (
                                <tr>
                                    <td><a href={"/reports/Edit/ProfitAndLossStatementActualVsBudget?name=Profit and Loss Statement (Actual vs Budget)"}><button>Edit</button></a></td>
                                    <td><a href={"/reports/view"}><button>View</button></a></td>
                                    <td style={{textAlign: "center"}}>dwad</td>
                                    <td style={{textAlign: "center"}}>adwaw</td>
                                    <td>wadwad</td>
                    ...
                    : id === "BalanceSheet" && localStorage.getItem("BalanceSheet")
                    ?
                        <table style={{width: "100%"}}>
                        <tr>
                            <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                            <th id="td-2"><i class="fas fa-print" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                            <th id="td-3">Date</th>
                            <th id="td-5" style={{width: "auto", textAlign: "left"}}>Description</th>
                        </tr>
                        {reportsData.map(element => {
                            return (
                            <tr>
                                <td><a href={"/reports/Edit/BalanceSheet?name=Balance Sheet"}><button>Edit</button></a></td>
                                <td><a href={"/reports/view"}><button>View</button></a></td>
                                <td style={{textAlign: "center"}}>dwad</td>
                                <td>adwaw</td>
                            </tr>
                    ...
                    : id === "StatementOfChangesInEquity" && localStorage.getItem("StatementOfChangesInEquity")
                    ?
                        <table style={{width: "100%"}}>
                            <tr>
                                <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                                <th id="td-2"><i class="fas fa-print" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                                <th id="td-3">From</th>
                                <th id="td-4" style={{width: "10%",textAlign: "center"}}>To</th>
                                <th id="td-5" style={{width: "auto", textAlign: "left"}}>Description</th>
                            </tr>
                            {reportsData.map(element => {
                                return (
                                <tr>
                                    <td><a href={"/reports/Edit/StatementOfChangesInEquity?name=Statement of Changes in Equity"}><button>Edit</button></a></td>
                                    <td><a href={"/reports/view"}><button>View</button></a></td>
                                    <td style={{textAlign: "center"}}>dwad</td>
                                    <td style={{textAlign: "center"}}>adwaw</td>
                                    <td>wadwad</td>
                    ...
                    : id === "TrialBalance" && localStorage.getItem("TrialBalance")
                    ?
                        <table style={{width: "100%"}}>
                            <tr>
                                <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                                ...
                                <th id="td-3">From</th>
                                <th id="td-4" style={{width: "10%",textAlign: "center"}}>To</th>
                                <th id="td-4" style={{width: "17%",textAlign: "center"}}>Accounting method</th>
                                <th id="td-5" style={{width: "auto", textAlign: "left"}}>Description</th>
                            </tr>
                            {reportsData.map(element => {
                                return (
                                <tr>
                                    <td><a href={"/reports/Edit/TrialBalance?name=Trial Balance"}><button>Edit</button></a></td>
                                    <td><a href={"/reports/view"}><button>View</button></a></td>
                                    <td style={{textAlign: "center"}}>dwad</td>
                                    <td style={{textAlign: "center"}}>adwaw</td>
                                    <td style={{textAlign: "center"}}>adwaw</td>
                    ...
                    : id === "GeneralLedgerSummary" && localStorage.getItem("GeneralLedgerSummary")
                    ?
                        <table style={{width: "100%"}}>
                            <tr>
                                <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                            ...
                            {reportsData.map(element => {
                                return (
                                <tr>
                                    <td><a href={"/reports/Edit/GeneralLedgerSummary?name=General Ledger Summary"}><button>Edit</button></a></td>
                                    <td><a href={"/reports/view"}><button>View</button></a></td>
                                    <td style={{textAlign: "center"}}>dwad</td>
                                    <td style={{textAlign: "center"}}>adwaw</td>
                                    <td>wadwad</td>
                    ...
                    : id === "GeneralLedgerTransactions" && localStorage.getItem("GeneralLedgerSummary")
                    ?
                        <table style={{width: "100%"}}>
                            <tr>
                                <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
                            ...
                            {reportsData.map(element => {
                                return (
                                <tr>
                                    <td><a href={"/reports/Edit/GeneralLedgerTransactions?name=General Ledger Transactions"}><button>Edit</button></a></td>
                                    <td><a href={"/reports/view"}><button>View</button></a></td>
                                    <td style={{textAlign: "center"}}>dwad</td>
                                    <td style={{textAlign: "center"}}>adwaw</td>
                                    <td>wadwad</td>
                    ...
                    : id === "CustomReports" && localStorage.getItem("CustomReports")
                    &&
                    <table style={{width: "100%"}}>
                    <tr>
                        <th id="td-1"><i class="fas fa-edit" style={{fontSize: "16px", opacity: 0.25}}></i></th>
            ...
            <a href={
                ...
                <button className="button">New Report</button></a> 
            </a>
            </div>
            }
